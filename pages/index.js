...
export default function Home() {
	return (
		<>
				...
				<Element id="services" name="services">
					<div className={css.grid}>
						...
						<ContentBox
							...
							underscoreColor="accent_2"
							backgroundColor="black"
							backgroundImage="/assets/content_boxes/img_1.png"
						/>
						<ContentBox
							title="Production"
						...
						<ContentBox
							...
							underscoreColor="accent_2"
							backgroundColor="black"
							backgroundImage="/assets/content_boxes/img_2.png"
						/>
						<ContentBox
							title="Digital Pr"
			...
			<Border />
			<Container className={classNames(css.container, css.clientsSlider)}>
				<ClientsSlider />
			</Container>
			<Border />
			<SectionContactUs />
